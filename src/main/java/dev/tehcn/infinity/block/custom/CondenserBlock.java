package dev.tehcn.infinity.block.custom;

import dev.tehcn.infinity.block.entity.CondenserBlockEntity;
...
public class CondenserBlock extends BlockWithEntity implements BlockEntityProvider {
    ...
    public <T extends BlockEntity> BlockEntityTicker<T> getTicker(World world, BlockState state, BlockEntityType<T> type) {
        return checkType(type, ModBlockEntities.CONDENSER, CondenserBlockEntity::tick);
    }
}
