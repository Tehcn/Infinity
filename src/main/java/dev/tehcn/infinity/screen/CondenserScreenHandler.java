...
public class CondenserScreenHandler extends ScreenHandler {
    ...
    public CondenserScreenHandler(int syncId, PlayerInventory playerInventory, Inventory inventory, PropertyDelegate delegate) {
    ...
    public int getScaledEnergy() {
        ...
        return capacity != 0 && energy != 0 ? energy * energyBarSize / capacity : 0;
    }
